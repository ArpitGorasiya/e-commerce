...
// const Cart = () => {
//   const { cart, removeFromCart, addToWishlist, updateCartQuantity } =
//     useCartWishlist();
...
const Cart = () => {
  ...
  const [orderPlaced, setOrderPlaced] = React.useState(false); // State to manage order success
  const [loading, setLoading] = React.useState(false); // State for loading animation during checkout
